...
#  error uh oh, READ is already defined
  ...
  // pins pulled high.  Note that in practice they shouldn't need a this long
  // to settle, at least with the anticipated capacitances connected to them.
  // But the chip runs fast enough that not waiting at all can be too fast.
...
#  define INPUT_HIGH
    ...
    defined(TEST_CONDITION_PD7_LOW_OTHERS_NC)
#  define INPUT_LOW
#elif defined(TEST_CONDITION_PB0_WEAK_LOW_470_KOHM_OTHERS_NC) || \
    defined(TEST_CONDITION_PB1_WEAK_LOW_470_KOHM_OTHERS_NC) || \
    defined(TEST_CONDITION_PB2_WEAK_LOW_470_KOHM_OTHERS_NC) || \
    defined(TEST_CONDITION_PB3_WEAK_LOW_470_KOHM_OTHERS_NC) || \
    defined(TEST_CONDITION_PB4_WEAK_LOW_470_KOHM_OTHERS_NC) || \
    ...
    defined(TEST_CONDITION_PD6_WEAK_LOW_470_KOHM_OTHERS_NC) || \
    defined(TEST_CONDITION_PD7_WEAK_LOW_470_KOHM_OTHERS_NC)
#  define INPUT_WEAK_LOW_470_KOHM
...
#  endif
...
#elif defined(INPUT_WEAK_LOW_470_KOHM)
  ...
  // by the test condition name and also on careful human observation of
